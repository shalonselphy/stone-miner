...
This is a sample template for stone-miner - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name stone-miner --tail
```
...
```bash
aws cloudformation delete-stack --stack-name stone-miner
```
